...
def registerUDFs(spark: SparkSession):
    ...
    spark.udf.register("rolling_arr_window", rolling_arr_window)
...
def rolling_arr_windowGenerator():
    ...
    @udf(returnType = ArrayType(ArrayType(StringType())))
    def func(text: list, window_size: int):
...
rolling_arr_window = rolling_arr_windowGenerator()
